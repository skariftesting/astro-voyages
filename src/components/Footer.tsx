...
const Footer = () => {
  return (
    <footer className="bg-space-light-blue/90 mt-16 py-12 px-4 md:px-6 mx-4 md:mx-8 lg:mx-12 mb-4 md:mb-8 lg:mb-12 rounded-md border border-space-light-blue/10 shadow-lg">
